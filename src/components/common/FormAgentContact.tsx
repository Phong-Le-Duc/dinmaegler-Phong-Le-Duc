...
import { agentContactSchema } from "../../utility/schemas";
...
export default function FormAgentContact({ agent }: AgentContactProps) {
    type FormErrors = {
    ...
    function handleSubmit(event: React.FormEvent) {
        ...
        const result = agentContactSchema.safeParse(data);
