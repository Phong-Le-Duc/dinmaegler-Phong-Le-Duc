                ...
                <div className="relative h-[310px]">
                    <figure className="w-full h-full">
                        ...
                        />
                            ...
                            {/* Blue border: keep absolute on md+ but stack under image on mobile */}
                            <div className="md:absolute w-48 h-48 md:w-80 md:h-80 md:top-5 md:left-5 border-[10px] border-dinmaegler-blue pointer-events-none mt-4 md:mt-0">
